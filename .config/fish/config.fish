...
function readenv --on-variable PWD
    if test -r .env && string match -qr '.*development.*rivery.*' $PWD
...
if [ -f '/Users/oryan/dataset/google-cloud-sdk/path.fish.inc' ]; . '/Users/oryan/dataset/google-cloud-sdk/path.fish.inc'; end
